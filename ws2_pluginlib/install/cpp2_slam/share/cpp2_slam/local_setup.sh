...
: ${AMENT_CURRENT_PREFIX:="/shared/ws2_pluginlib/install/cpp2_slam"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp2_slam/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp2_slam/environment/path.sh"
