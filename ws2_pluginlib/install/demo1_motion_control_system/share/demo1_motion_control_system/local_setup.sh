...
: ${AMENT_CURRENT_PREFIX:="/shared/ws2_pluginlib/install/demo1_motion_control_system"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/demo1_motion_control_system/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/demo1_motion_control_system/environment/path.sh"
