...
: ${AMENT_CURRENT_PREFIX:="/shared/ws2_pluginlib/install/cpp1_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp1_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp1_gazebo/environment/path.sh"
