...
: ${AMENT_CURRENT_PREFIX:="/shared/ws2_pluginlib/install/nav2_custom_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_custom_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_custom_controller/environment/path.sh"
