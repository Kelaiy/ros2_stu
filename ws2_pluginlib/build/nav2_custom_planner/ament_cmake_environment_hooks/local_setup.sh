...
: ${AMENT_CURRENT_PREFIX:="/shared/ws2_pluginlib/install/nav2_custom_planner"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_custom_planner/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_custom_planner/environment/path.sh"
