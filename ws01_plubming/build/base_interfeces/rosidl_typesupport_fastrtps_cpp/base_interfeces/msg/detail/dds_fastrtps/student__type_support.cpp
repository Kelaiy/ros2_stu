...
#include "base_interfeces/msg/detail/student__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_interfeces::msg::Student;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_interfeces::msg::Student *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_interfeces::msg::Student *>(
    untyped_ros_message);
...
{
  return &base_interfeces::msg::typesupport_fastrtps_cpp::_Student__handle;
}
