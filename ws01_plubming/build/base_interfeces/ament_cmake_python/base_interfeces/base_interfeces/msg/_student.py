...
class Metaclass_Student(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class StudentConstants(typing.TypedDict):
        pass

    __constants: StudentConstants = {
    }
...
class Student(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Student):
    ...
    def __init__(self, *,
                 ...
                 age: typing.Optional[int] = None,  # noqa: E501
                 height: typing.Optional[float] = None,  # noqa: E501
        ...
        self.age = age if age is not None else int()
        self.height = height if height is not None else float()
