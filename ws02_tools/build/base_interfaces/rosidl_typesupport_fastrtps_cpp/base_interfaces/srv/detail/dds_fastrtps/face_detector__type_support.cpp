...
#include "base_interfaces/srv/detail/face_detector__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const base_interfaces::srv::FaceDetector_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_interfaces::srv::FaceDetector_Request & ros_message)
{
  // Member: image
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_interfaces::srv::FaceDetector_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_interfaces::srv::FaceDetector_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_interfaces::srv::FaceDetector_Request *>(
    untyped_ros_message);
...
{
  return &base_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interfaces, srv, FaceDetector_Request)() {
  return &base_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_base_interfaces
cdr_serialize(
  const base_interfaces::srv::FaceDetector_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: number
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_interfaces::srv::FaceDetector_Response & ros_message)
{
  // Member: number
  cdr >> ros_message.number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_interfaces::srv::FaceDetector_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_interfaces::srv::FaceDetector_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<base_interfaces::srv::FaceDetector_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &base_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interfaces, srv, FaceDetector_Response)() {
  return &base_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Response__handle;
}
...
// functions for base_interfaces::srv::FaceDetector_Request already declared above

// functions for base_interfaces::srv::FaceDetector_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_base_interfaces
cdr_serialize(
  const base_interfaces::srv::FaceDetector_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      base_interfaces::srv::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_interfaces::srv::FaceDetector_Event & ros_message)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      base_interfaces::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        base_interfaces::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        base_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_FaceDetector_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        base_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_FaceDetector_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_interfaces::srv::FaceDetector_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      base_interfaces::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        base_interfaces::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        base_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_FaceDetector_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        base_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_FaceDetector_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const base_interfaces::srv::FaceDetector_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<base_interfaces::srv::FaceDetector_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &base_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interfaces, srv, FaceDetector_Event)() {
  return &base_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Event__handle;
}
...
static const rosidl_service_type_support_t _FaceDetector__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<base_interfaces::srv::FaceDetector_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<base_interfaces::srv::FaceDetector_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<base_interfaces::srv::FaceDetector_Event>(),
...
{
  return &base_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interfaces, srv, FaceDetector)() {
  return &base_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector__handle;
}
