...
#ifndef BASE_INTERFACES__SRV__DETAIL__FACE_DETECTOR__FUNCTIONS_H_
#define BASE_INTERFACES__SRV__DETAIL__FACE_DETECTOR__FUNCTIONS_H_
 ...
 * )) before or use
 * base_interfaces__srv__FaceDetector_Request__create()
 ...
 * calls
 * base_interfaces__srv__FaceDetector_Request__init().
...
/**
 * It calls
 * base_interfaces__srv__FaceDetector_Request__fini()
 ...
 * base_interfaces__srv__FaceDetector_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * base_interfaces__srv__FaceDetector_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * base_interfaces__srv__FaceDetector_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * base_interfaces__srv__FaceDetector_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces
...
/**
 * It calls
 * base_interfaces__srv__FaceDetector_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces
...
/**
 * It allocates the memory for the array and calls
 * base_interfaces__srv__FaceDetector_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces
...
/**
 * It calls
 * base_interfaces__srv__FaceDetector_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * base_interfaces__srv__FaceDetector_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * base_interfaces__srv__FaceDetector_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces
...
/**
 * It calls
 * base_interfaces__srv__FaceDetector_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces
...
/**
 * It allocates the memory for the array and calls
 * base_interfaces__srv__FaceDetector_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces
...
/**
 * It calls
 * base_interfaces__srv__FaceDetector_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BASE_INTERFACES__SRV__DETAIL__FACE_DETECTOR__FUNCTIONS_H_
