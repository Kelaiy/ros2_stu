...
def generate_launch_description():
    ...
    # p_value = ParameterValue(Command(["xacro ",get_package_share_directory("cpp6_urdf") + "/urdf/urdf/demo1_student.urdf"]))
    ...
    rviz2 = Node(
        package='rviz2',
        executable='rviz2',
        arguments=[{"-d",get_package_share_directory("cpp6_urdf") + "/rviz/urdf.rviz"}]
    )
